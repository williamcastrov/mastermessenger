...
use App\Models\Interlocutores\Empleados;
    ...
    public function create(Request $request){
      ...
      public function listar_empleados(){  
        try {
          ...
          FROM empleados as t0 INNER JOIN empresa as t1 INNER JOIN estados as t2 INNER JOIN ciudades as t3
                               INNER JOIN tipo_interlocutor as t4
          WHERE t0.codigo_tipo_emp = 3 and t0.empresa_emp = t1.id_emp and t0.estado_emp = t2.id_est 
          and t0.ciudad_emp = t3.id_ciu and t0.codigo_tipo_emp = t4.id_tint");
      ...
      public function get($id_emp){
        try { 
          ...
          FROM empleados as t0 INNER JOIN empresa as t1 INNER JOIN estados as t2 INNER JOIN ciudades as t3
                               INNER JOIN tipo_interlocutor as t5
          WHERE t0.codigo_tipo_emp  = 3         and t0.empresa_emp     = t1.id_emp and t0.estado_emp = t2.id_est 
            and t0.ciudad_emp       = t3.id_ciu and t0.codigo_tipo_emp = t4.id_tint and t0.id_emp    = $id_emp");
      ...
      public function update(Request $request, $id_emp){
        try {
          ...
          $res = Empleados::where("id_emp",$id_emp)->update($data);
      ...
      public function delete($id_emp){ 
        try {
          $res = Empleados::where("id_emp",$id_emp)->delete($id_emp);
          $response['res'] = $res;
