...
function PedidosMensajero(props) {
  ...
  useEffect(() => {
    async function fetchDataPedidos() {
      const res = await pedidosServices.leerpedidosmensajeros(idUsu);
      //console.log("DATOS PEDIDOS MENSAJERO : ", res.data)
  ...
  return (
    <div className="App">
      ...
      <MaterialTable
        ...
        title="CONSULTA PEDIDOS MENSAJERO"
        actions={[
          {
            icon: 'edit',
...
export default PedidosMensajero;
