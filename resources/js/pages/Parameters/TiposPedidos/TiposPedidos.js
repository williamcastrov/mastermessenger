...
import tipospedidosServices from "../../../services/Parameters/TiposPedidos";
 ...
 // "string","boolean","numeric","date","datetime","time","currency"
  ...
  const tiposservicioInsertar=(
    <div className={styles.modal}>
      ...
      <br />
      <TextField className={styles.inputMaterial} label="Descripción" name="descripcion_tpd" onChange={handleChange} />          
      <br />
  ...
  const tiposservicioEditar = (
    <div className={styles.modal}>
      ...
      <br />
      <TextField className={styles.inputMaterial} label="Descripción" name="descripcion_tpd" onChange={handleChange} value={tiposServicioSeleccionado&&tiposServicioSeleccionado.descripcion_tpd}/>
      <br />
      <FormControl className={styles.formControl}>
        <InputLabel id="idselectEmpresa">Empresa</InputLabel>
        <Select
  ...
  const tiposservicioEliminar = (
    <div className={styles.modal}>
      <p>Estás seguro que deseas eliminar el Tipo de Servicio <b>{tiposServicioSeleccionado && tiposServicioSeleccionado.descripcion_tpd}</b>? </p>
      <div align="right">
