...
*/
        ...
        <Grid item xs={12} md={6}> 
          <FormControl className={styles.formControl}>
            <InputLabel id="idselectEspecialidad" >Especialidad</InputLabel>
              ...
              <MenuItem value=""> <em>None</em> </MenuItem>
              {
                listarEspecialidades && listarEspecialidades.map((itemselect) => {
                return (
  ...
  return (
    <div className="App">
      <br />
      <Button className={styles.button} variant="contained" startIcon={<SaveIcon />} onClick={() => abrirCerrarModalInsertar()} >Agregar Empleado</Button>
      <MaterialTable
        columns={columnas}
